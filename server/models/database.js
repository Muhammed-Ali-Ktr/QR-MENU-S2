...
const insertDefaultSettings = async () => {
  return new Promise((resolve) => {
    const defaultSettings = [
      { key: 'company_name', value: 'QR Menü Restoran' },
      { key: 'company_slogan', value: '' },
      { key: 'company_logo', value: '' },
      { key: 'company_icon', value: '' },
      { key: 'primary_color', value: '#d8a200' },
      { key: 'hover_color', value: '#a80075' },
      { key: 'header_color', value: '#ee2' },
      ...
      { key: 'menu_url', value: 'https://ziftstudio.digital/' },
      { key: 'restaurant_name', value: 'Cafe Aroma' },
      { key: 'restaurant_description', value: 'Taze lezzetler, kaliteli hizmet' },
      { key: 'restaurant_logo', value: '' },
      { key: 'restaurant_icon', value: '' },
      { key: 'restaurant_slogan', value: 'Taze lezzetler, kaliteli hizmet, hijyenik sunum ve güler yüzlü anlayışla her zaman yanınızdayız. Keyifli sofralarda buluşmak dileğiyle, afiyet olsun!' },
      { key: 'wifi_name', value: 'ca 6G' },
      { key: 'wifi_password', value: '147258369CafeAroma2030' },
